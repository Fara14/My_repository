...
print(f"(4) принимает на вход число. Если оно от 3 до 6 включительно, то уменьшить его на 13. Если оно от 8 до 41, то уменьшить на 50.\n"
      f"Если оно не более 0 или более 2000, то увеличить в 4 раза. Иначе занулить это число. Вернуть результат\n {f4(2)}\n")
...
print(f"(7) получает на вход количество недель, месяцев, лет и выводит количество дней за это время. Считать, что в месяце 30 дней.\n {f7(0, 4, 3)}\n")
